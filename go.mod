...
replace github.com/hashicorp/terraform-provider-google-beta => github.com/modular-magician/terraform-provider-google-beta v1.20.1-0.20230809195620-ecd97cd71b83
