...
const ComputeUrlMapAssetNameRegex string = "projects/(?P<project>[^/]+)/global/urlMaps"
...
func NewComputeUrlMapConverter(name string, schema map[string]*schema.Schema) common.Converter {
...
func (c *ComputeUrlMapConverter) convertResourceData(asset *caiasset.Asset, config *transport_tpg.Config) (*common.HCLResourceBlock, error) {
	...
	hcl, _ := resourceComputeUrlMapRead(assetResourceData, config)
...
func resourceComputeUrlMapRead(resource map[string]interface{}, config *transport_tpg.Config) (map[string]interface{}, error) {
	result := make(map[string]interface{})
	var resource_data *schema.ResourceData = nil

	result["creation_timestamp"] = flattenComputeUrlMapCreationTimestamp(resource["creationTimestamp"], resource_data, config)
	result["default_service"] = flattenComputeUrlMapDefaultService(resource["defaultService"], resource_data, config)
	result["description"] = flattenComputeUrlMapDescription(resource["description"], resource_data, config)
	result["map_id"] = flattenComputeUrlMapMapId(resource["id"], resource_data, config)
	result["fingerprint"] = flattenComputeUrlMapFingerprint(resource["fingerprint"], resource_data, config)
	result["header_action"] = flattenComputeUrlMapHeaderAction(resource["headerAction"], resource_data, config)
	result["host_rule"] = flattenComputeUrlMapHostRule(resource["hostRules"], resource_data, config)
	result["name"] = flattenComputeUrlMapName(resource["name"], resource_data, config)
	result["path_matcher"] = flattenComputeUrlMapPathMatcher(resource["pathMatchers"], resource_data, config)
	result["test"] = flattenComputeUrlMapTest(resource["tests"], resource_data, config)
	result["default_url_redirect"] = flattenComputeUrlMapDefaultUrlRedirect(resource["defaultUrlRedirect"], resource_data, config)
	result["default_route_action"] = flattenComputeUrlMapDefaultRouteAction(resource["defaultRouteAction"], resource_data, config)
