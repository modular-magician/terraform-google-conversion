...
const AccessContextManagerServicePerimetersAssetNameRegex string = "(?P<parent>[^/]+)/servicePerimeters:replaceAll"

type AccessContextManagerServicePerimetersConverter struct {
	name   string
	schema map[string]*schema.Schema
}

func NewAccessContextManagerServicePerimetersConverter(name string, schema map[string]*schema.Schema) common.Converter {
	return &AccessContextManagerServicePerimetersConverter{
		name:   name,
		schema: schema,
	}
}

func (c *AccessContextManagerServicePerimetersConverter) Convert(assets []*caiasset.Asset) ([]*common.HCLResourceBlock, error) {
...
func (c *AccessContextManagerServicePerimetersConverter) convertResourceData(asset *caiasset.Asset, config *transport_tpg.Config) (*common.HCLResourceBlock, error) {
	...
	hcl, _ := resourceAccessContextManagerServicePerimetersRead(assetResourceData, config)
...
func resourceAccessContextManagerServicePerimetersRead(resource map[string]interface{}, config *transport_tpg.Config) (map[string]interface{}, error) {
	result := make(map[string]interface{})
	var resource_data *schema.ResourceData = nil

	result["service_perimeters"] = flattenAccessContextManagerServicePerimetersServicePerimeters(resource["servicePerimeters"], resource_data, config)
