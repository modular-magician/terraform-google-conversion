...
func VertexAIEndpointIamUpdaterProducer(d tpgresource.TerraformResourceData, config *transport_tpg.Config) (tpgiamresource.ResourceIamUpdater, error) {
	...
	m, err := tpgresource.GetImportIdQualifiers([]string{"projects/(?P<project>[^/]+)/locations/(?P<region>[^/]+)/endpoints/(?P<endpoint>[^/]+)", "(?P<project>[^/]+)/(?P<region>[^/]+)/(?P<endpoint>[^/]+)", "(?P<region>[^/]+)/(?P<endpoint>[^/]+)", "(?P<endpoint>[^/]+)"}, d, config, d.Get("endpoint").(string))
	if err != nil {
		return nil, err
	}
...
func VertexAIEndpointIdParseFunc(d *schema.ResourceData, config *transport_tpg.Config) error {
	...
	m, err := tpgresource.GetImportIdQualifiers([]string{"projects/(?P<project>[^/]+)/locations/(?P<region>[^/]+)/endpoints/(?P<endpoint>[^/]+)", "(?P<project>[^/]+)/(?P<region>[^/]+)/(?P<endpoint>[^/]+)", "(?P<region>[^/]+)/(?P<endpoint>[^/]+)", "(?P<endpoint>[^/]+)"}, d, config, d.Id())
	if err != nil {
		return err
	}
