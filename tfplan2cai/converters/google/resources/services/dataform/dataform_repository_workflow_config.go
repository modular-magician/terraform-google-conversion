...
func ResourceConverterDataformRepositoryWorkflowConfig() tpgresource.ResourceConverter {
...
func GetDataformRepositoryWorkflowConfigCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//dataform.googleapis.com/projects/{{project}}/locations/{{region}}/repositories/{{repository}}/workflowConfigs/{{name}}")
	if err != nil {
