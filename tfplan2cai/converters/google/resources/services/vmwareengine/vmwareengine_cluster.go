...
func expandVmwareengineClusterAutoscalingSettingsAutoscalingPolicies(v interface{}, d tpgresource.TerraformResourceData, config *transport_tpg.Config) (map[string]interface{}, error) {
	...
	for _, raw := range v.(*schema.Set).List() {
		...
		transformedMinNodeCount, err := expandVmwareengineClusterAutoscalingSettingsAutoscalingPoliciesMinNodeCount(original["min_node_count"], d, config)
		if err != nil {
			return nil, err
		...
		transformedMaxNodeCount, err := expandVmwareengineClusterAutoscalingSettingsAutoscalingPoliciesMaxNodeCount(original["max_node_count"], d, config)
		if err != nil {
			return nil, err
		...
		transformedGrantedMemoryThresholds, err := expandVmwareengineClusterAutoscalingSettingsAutoscalingPoliciesGrantedMemoryThresholds(original["granted_memory_thresholds"], d, config)
		if err != nil {
			return nil, err
...
func expandVmwareengineClusterAutoscalingSettingsAutoscalingPoliciesMinNodeCount(v interface{}, d tpgresource.TerraformResourceData, config *transport_tpg.Config) (interface{}, error) {
	return v, nil
}

func expandVmwareengineClusterAutoscalingSettingsAutoscalingPoliciesMaxNodeCount(v interface{}, d tpgresource.TerraformResourceData, config *transport_tpg.Config) (interface{}, error) {
	return v, nil
}
...
func expandVmwareengineClusterAutoscalingSettingsAutoscalingPoliciesGrantedMemoryThresholds(v interface{}, d tpgresource.TerraformResourceData, config *transport_tpg.Config) (interface{}, error) {
	l := v.([]interface{})
	if len(l) == 0 || l[0] == nil {
		return nil, nil
	}
	...
	transformedScaleOut, err := expandVmwareengineClusterAutoscalingSettingsAutoscalingPoliciesGrantedMemoryThresholdsScaleOut(original["scale_out"], d, config)
	if err != nil {
		return nil, err
	} else if val := reflect.ValueOf(transformedScaleOut); val.IsValid() && !tpgresource.IsEmptyValue(val) {
		transformed["scaleOut"] = transformedScaleOut
	...
	transformedScaleIn, err := expandVmwareengineClusterAutoscalingSettingsAutoscalingPoliciesGrantedMemoryThresholdsScaleIn(original["scale_in"], d, config)
	if err != nil {
		return nil, err
	} else if val := reflect.ValueOf(transformedScaleIn); val.IsValid() && !tpgresource.IsEmptyValue(val) {
		transformed["scaleIn"] = transformedScaleIn
...
func expandVmwareengineClusterAutoscalingSettingsAutoscalingPoliciesGrantedMemoryThresholdsScaleOut(v interface{}, d tpgresource.TerraformResourceData, config *transport_tpg.Config) (interface{}, error) {
	return v, nil
}

func expandVmwareengineClusterAutoscalingSettingsAutoscalingPoliciesGrantedMemoryThresholdsScaleIn(v interface{}, d tpgresource.TerraformResourceData, config *transport_tpg.Config) (interface{}, error) {
	return v, nil
}
