...
func expandVmwareenginePrivateCloudManagementClusterAutoscalingSettingsAutoscalingPolicies(v interface{}, d tpgresource.TerraformResourceData, config *transport_tpg.Config) (map[string]interface{}, error) {
	...
	for _, raw := range v.(*schema.Set).List() {
		...
		transformedMinNodeCount, err := expandVmwareenginePrivateCloudManagementClusterAutoscalingSettingsAutoscalingPoliciesMinNodeCount(original["min_node_count"], d, config)
		if err != nil {
			return nil, err
		...
		transformedMaxNodeCount, err := expandVmwareenginePrivateCloudManagementClusterAutoscalingSettingsAutoscalingPoliciesMaxNodeCount(original["max_node_count"], d, config)
		if err != nil {
			return nil, err
		...
		transformedGrantedMemoryThresholds, err := expandVmwareenginePrivateCloudManagementClusterAutoscalingSettingsAutoscalingPoliciesGrantedMemoryThresholds(original["granted_memory_thresholds"], d, config)
		if err != nil {
			return nil, err
		} else if val := reflect.ValueOf(transformedGrantedMemoryThresholds); val.IsValid() && !tpgresource.IsEmptyValue(val) {
			transformed["grantedMemoryThresholds"] = transformedGrantedMemoryThresholds
		}
...
func expandVmwareenginePrivateCloudManagementClusterAutoscalingSettingsAutoscalingPoliciesMinNodeCount(v interface{}, d tpgresource.TerraformResourceData, config *transport_tpg.Config) (interface{}, error) {
	return v, nil
}

func expandVmwareenginePrivateCloudManagementClusterAutoscalingSettingsAutoscalingPoliciesMaxNodeCount(v interface{}, d tpgresource.TerraformResourceData, config *transport_tpg.Config) (interface{}, error) {
	return v, nil
}
...
func expandVmwareenginePrivateCloudManagementClusterAutoscalingSettingsAutoscalingPoliciesGrantedMemoryThresholds(v interface{}, d tpgresource.TerraformResourceData, config *transport_tpg.Config) (interface{}, error) {
	l := v.([]interface{})
	if len(l) == 0 || l[0] == nil {
		return nil, nil
	}
	...
	transformedScaleOut, err := expandVmwareenginePrivateCloudManagementClusterAutoscalingSettingsAutoscalingPoliciesGrantedMemoryThresholdsScaleOut(original["scale_out"], d, config)
	if err != nil {
		return nil, err
	} else if val := reflect.ValueOf(transformedScaleOut); val.IsValid() && !tpgresource.IsEmptyValue(val) {
		transformed["scaleOut"] = transformedScaleOut
	...
	transformedScaleIn, err := expandVmwareenginePrivateCloudManagementClusterAutoscalingSettingsAutoscalingPoliciesGrantedMemoryThresholdsScaleIn(original["scale_in"], d, config)
	if err != nil {
		return nil, err
	} else if val := reflect.ValueOf(transformedScaleIn); val.IsValid() && !tpgresource.IsEmptyValue(val) {
		transformed["scaleIn"] = transformedScaleIn
...
func expandVmwareenginePrivateCloudManagementClusterAutoscalingSettingsAutoscalingPoliciesGrantedMemoryThresholdsScaleOut(v interface{}, d tpgresource.TerraformResourceData, config *transport_tpg.Config) (interface{}, error) {
	return v, nil
}

func expandVmwareenginePrivateCloudManagementClusterAutoscalingSettingsAutoscalingPoliciesGrantedMemoryThresholdsScaleIn(v interface{}, d tpgresource.TerraformResourceData, config *transport_tpg.Config) (interface{}, error) {
	return v, nil
}
