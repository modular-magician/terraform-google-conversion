...
const ModelArmorTemplateAssetType string = "modelarmor.{{location}}.rep.googleapis.com/Template"
...
func GetModelArmorTemplateCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]cai.Asset, error) {
	name, err := cai.AssetName(d, config, "//modelarmor.{{location}}.rep.googleapis.com/projects/{{project}}/locations/{{location}}/templates/{{template_id}}")
	if err != nil {
	...
	if obj, err := GetModelArmorTemplateApiObject(d, config); err == nil {
		return []cai.Asset{{
			...
			Resource: &cai.AssetResource{
				Version:              "v1",
				DiscoveryDocumentURI: "https://www.googleapis.com/discovery/v1/apis/modelarmor.{{location}}.rep/v1/rest",
...
func GetModelArmorTemplateApiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) (map[string]interface{}, error) {
	...
	if err != nil {
		return nil, err
	} else if v, ok := d.GetOkExists("filter_config"); !tpgresource.IsEmptyValue(reflect.ValueOf(filterConfigProp)) && (ok || !reflect.DeepEqual(v, filterConfigProp)) {
...
func expandModelArmorTemplateFilterConfigRaiSettings(v interface{}, d tpgresource.TerraformResourceData, config *transport_tpg.Config) (interface{}, error) {
	...
	transformedFilterVersion, err := expandModelArmorTemplateFilterConfigRaiSettingsFilterVersion(original["filter_version"], d, config)
	if err != nil {
		return nil, err
	} else if val := reflect.ValueOf(transformedFilterVersion); val.IsValid() && !tpgresource.IsEmptyValue(val) {
		transformed["filterVersion"] = transformedFilterVersion
	}
...
func expandModelArmorTemplateFilterConfigRaiSettingsFilterVersion(v interface{}, d tpgresource.TerraformResourceData, config *transport_tpg.Config) (interface{}, error) {
	return v, nil
}
...
func expandModelArmorTemplateFilterConfigPiAndJailbreakFilterSettings(v interface{}, d tpgresource.TerraformResourceData, config *transport_tpg.Config) (interface{}, error) {
	...
	transformedFilterVersion, err := expandModelArmorTemplateFilterConfigPiAndJailbreakFilterSettingsFilterVersion(original["filter_version"], d, config)
	if err != nil {
		return nil, err
	} else if val := reflect.ValueOf(transformedFilterVersion); val.IsValid() && !tpgresource.IsEmptyValue(val) {
		transformed["filterVersion"] = transformedFilterVersion
...
func expandModelArmorTemplateFilterConfigPiAndJailbreakFilterSettingsFilterVersion(v interface{}, d tpgresource.TerraformResourceData, config *transport_tpg.Config) (interface{}, error) {
	return v, nil
}
