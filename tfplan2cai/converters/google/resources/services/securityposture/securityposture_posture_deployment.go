...
func GetSecurityposturePostureDeploymentCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]cai.Asset, error) {
	name, err := cai.AssetName(d, config, "//securityposture.googleapis.com/{{parent}}/postureDeployments/{{posture_deployment_id}}")
	if err != nil {
...
func GetSecurityposturePostureDeploymentApiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) (map[string]interface{}, error) {
	...
	annotationsProp, err := expandSecurityposturePostureDeploymentEffectiveAnnotations(d.Get("effective_annotations"), d, config)
	if err != nil {
		return nil, err
...
func expandSecurityposturePostureDeploymentEffectiveAnnotations(v interface{}, d tpgresource.TerraformResourceData, config *transport_tpg.Config) (map[string]string, error) {
	if v == nil {
