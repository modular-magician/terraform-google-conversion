...
func resourceInstanceMetadata_v2(d tpgresource.TerraformResourceData) (map[string]interface{}, error) {
...
func resourceInstancePartnerMetadata_v2(d tpgresource.TerraformResourceData) (map[string]interface{}, error) {
	partnerMetadata := map[string]interface{}{}
	...
	if len(partnerMetadataMap) > 0 {
		for key, value := range partnerMetadataMap {
			...
			partnerMetadata[key] = map[string]interface{}{
