	...
	if obj, err := GetIAM3PrincipalAccessBoundaryPolicyApiObject(d, config); err == nil {
		return []cai.Asset{{
			...
			Resource: &cai.AssetResource{
				Version:              "v3",
				DiscoveryDocumentURI: "https://www.googleapis.com/discovery/v1/apis/iam/v3/rest",
...
func GetIAM3PrincipalAccessBoundaryPolicyApiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) (map[string]interface{}, error) {
	...
	etagProp, err := expandIAM3PrincipalAccessBoundaryPolicyEtag(d.Get("etag"), d, config)
	if err != nil {
		return nil, err
...
func expandIAM3PrincipalAccessBoundaryPolicyEtag(v interface{}, d tpgresource.TerraformResourceData, config *transport_tpg.Config) (interface{}, error) {
	return v, nil
}
