...
func expandGkeonpremBareMetalAdminClusterLoadBalancerBgpLbConfigBgpPeerConfigs(v interface{}, d tpgresource.TerraformResourceData, config *transport_tpg.Config) (interface{}, error) {
	...
	for _, raw := range l {
		...
		transformedControlPanelNodes, err := expandGkeonpremBareMetalAdminClusterLoadBalancerBgpLbConfigBgpPeerConfigsControlPanelNodes(original["control_panel_nodes"], d, config)
		if err != nil {
			return nil, err
		} else if val := reflect.ValueOf(transformedControlPanelNodes); val.IsValid() && !tpgresource.IsEmptyValue(val) {
			transformed["controlPanelNodes"] = transformedControlPanelNodes
		}
...
func expandGkeonpremBareMetalAdminClusterLoadBalancerBgpLbConfigBgpPeerConfigsControlPanelNodes(v interface{}, d tpgresource.TerraformResourceData, config *transport_tpg.Config) (interface{}, error) {
	return v, nil
}
...
func expandGkeonpremBareMetalAdminClusterLoadBalancerBgpLbConfigLoadBalancerNodePoolConfigNodePoolConfigNodeConfigs(v interface{}, d tpgresource.TerraformResourceData, config *transport_tpg.Config) (interface{}, error) {
	...
	for _, raw := range l {
		...
		transformedProviderId, err := expandGkeonpremBareMetalAdminClusterLoadBalancerBgpLbConfigLoadBalancerNodePoolConfigNodePoolConfigNodeConfigsProviderId(original["provider_id"], d, config)
		if err != nil {
			return nil, err
		} else if val := reflect.ValueOf(transformedProviderId); val.IsValid() && !tpgresource.IsEmptyValue(val) {
			transformed["ProviderId"] = transformedProviderId
		}
		...
		transformedK8sIp, err := expandGkeonpremBareMetalAdminClusterLoadBalancerBgpLbConfigLoadBalancerNodePoolConfigNodePoolConfigNodeConfigsK8sIp(original["k8s_ip"], d, config)
		if err != nil {
			return nil, err
		} else if val := reflect.ValueOf(transformedK8sIp); val.IsValid() && !tpgresource.IsEmptyValue(val) {
			transformed["k8sIp"] = transformedK8sIp
		}
...
func expandGkeonpremBareMetalAdminClusterLoadBalancerBgpLbConfigLoadBalancerNodePoolConfigNodePoolConfigNodeConfigsProviderId(v interface{}, d tpgresource.TerraformResourceData, config *transport_tpg.Config) (interface{}, error) {
	return v, nil
}
...
func expandGkeonpremBareMetalAdminClusterLoadBalancerBgpLbConfigLoadBalancerNodePoolConfigNodePoolConfigNodeConfigsK8sIp(v interface{}, d tpgresource.TerraformResourceData, config *transport_tpg.Config) (interface{}, error) {
	return v, nil
}
...
func expandGkeonpremBareMetalAdminClusterLoadBalancerBgpLbConfigLoadBalancerNodePoolConfigNodePoolConfigTaints(v interface{}, d tpgresource.TerraformResourceData, config *transport_tpg.Config) (interface{}, error) {
	...
	transformedTimeAdded, err := expandGkeonpremBareMetalAdminClusterLoadBalancerBgpLbConfigLoadBalancerNodePoolConfigNodePoolConfigTaintsTimeAdded(original["time_added"], d, config)
	if err != nil {
		return nil, err
	} else if val := reflect.ValueOf(transformedTimeAdded); val.IsValid() && !tpgresource.IsEmptyValue(val) {
		transformed["timeAdded"] = transformedTimeAdded
	}
...
func expandGkeonpremBareMetalAdminClusterLoadBalancerBgpLbConfigLoadBalancerNodePoolConfigNodePoolConfigTaintsTimeAdded(v interface{}, d tpgresource.TerraformResourceData, config *transport_tpg.Config) (interface{}, error) {
	return v, nil
}
