...
func GetGKEBackupBackupPlanApiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) (map[string]interface{}, error) {
	...
	tagsProp, err := expandGKEBackupBackupPlanTags(d.Get("tags"), d, config)
	if err != nil {
		return nil, err
...
func expandGKEBackupBackupPlanTags(v interface{}, d tpgresource.TerraformResourceData, config *transport_tpg.Config) (map[string]string, error) {
	if v == nil {
