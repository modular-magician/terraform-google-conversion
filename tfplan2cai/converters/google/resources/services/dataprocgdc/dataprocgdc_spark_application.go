...
func GetDataprocGdcSparkApplicationApiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) (map[string]interface{}, error) {
	...
	requestedStateProp, err := expandDataprocGdcSparkApplicationRequestedState(d.Get("requested_state"), d, config)
	if err != nil {
		return nil, err
...
func expandDataprocGdcSparkApplicationSparkSqlApplicationConfigScriptVariables(v interface{}, d tpgresource.TerraformResourceData, config *transport_tpg.Config) (interface{}, error) {
	return v, nil
}
...
func expandDataprocGdcSparkApplicationRequestedState(v interface{}, d tpgresource.TerraformResourceData, config *transport_tpg.Config) (interface{}, error) {
	return v, nil
}
