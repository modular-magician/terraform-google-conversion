...
const BackupDRBackupVaultAssetType string = "autopush-backupdr.sandbox.googleapis.com/BackupVault"
...
func GetBackupDRBackupVaultCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]cai.Asset, error) {
	name, err := cai.AssetName(d, config, "//autopush-backupdr.sandbox.googleapis.com/projects/{{project}}/locations/{{location}}/backupVaults/{{backup_vault_id}}")
	if err != nil {
