...
func ResourceConverterCertificateManagerTrustConfig() tpgresource.ResourceConverter {
...
func GetCertificateManagerTrustConfigCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//certificatemanager.googleapis.com/projects/{{project}}/locations/{{location}}/trustConfigs/{{name}}")
	if err != nil {
