...
const SecretManagerRegionalRegionalSecretIAMAssetType string = "secretmanager.{{region}}.rep.googleapis.com/RegionalSecret"
...
func FetchSecretManagerRegionalRegionalSecretIamPolicy(d tpgresource.TerraformResourceData, config *transport_tpg.Config) (cai.Asset, error) {
	...
	return cai.FetchIamPolicy(
		...
		d,
		config,
		"//secretmanager.{{region}}.rep.googleapis.com/projects/{{project}}/locations/{{region}}/secrets/{{secret_id}}",
