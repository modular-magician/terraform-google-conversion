...
const SecretManagerRegionalRegionalSecretAssetType string = "secretmanager.{{region}}.rep.googleapis.com/RegionalSecret"
...
func GetSecretManagerRegionalRegionalSecretCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]cai.Asset, error) {
	name, err := cai.AssetName(d, config, "//secretmanager.{{region}}.rep.googleapis.com/projects/{{project}}/locations/{{region}}/secrets/{{secret_id}}")
	if err != nil {
	...
	if obj, err := GetSecretManagerRegionalRegionalSecretApiObject(d, config); err == nil {
		return []cai.Asset{{
			...
			Resource: &cai.AssetResource{
				Version:              "v1",
				DiscoveryDocumentURI: "https://www.googleapis.com/discovery/v1/apis/secretmanager.{{region}}.rep/v1/rest",
