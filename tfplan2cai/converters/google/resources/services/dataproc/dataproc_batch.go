...
func expandDataprocBatchRuntimeConfig(v interface{}, d tpgresource.TerraformResourceData, config *transport_tpg.Config) (interface{}, error) {
	...
	transformedRepositoryConfig, err := expandDataprocBatchRuntimeConfigRepositoryConfig(original["repository_config"], d, config)
	if err != nil {
		return nil, err
	} else if val := reflect.ValueOf(transformedRepositoryConfig); val.IsValid() && !tpgresource.IsEmptyValue(val) {
		transformed["repositoryConfig"] = transformedRepositoryConfig
	}
...
func expandDataprocBatchRuntimeConfigRepositoryConfig(v interface{}, d tpgresource.TerraformResourceData, config *transport_tpg.Config) (interface{}, error) {
	l := v.([]interface{})
	if len(l) == 0 || l[0] == nil {
		return nil, nil
	}
	...
	transformedPypiRepositoryConfig, err := expandDataprocBatchRuntimeConfigRepositoryConfigPypiRepositoryConfig(original["pypi_repository_config"], d, config)
	if err != nil {
		return nil, err
	} else if val := reflect.ValueOf(transformedPypiRepositoryConfig); val.IsValid() && !tpgresource.IsEmptyValue(val) {
		transformed["pypiRepositoryConfig"] = transformedPypiRepositoryConfig
	}

	return transformed, nil
}

func expandDataprocBatchRuntimeConfigRepositoryConfigPypiRepositoryConfig(v interface{}, d tpgresource.TerraformResourceData, config *transport_tpg.Config) (interface{}, error) {
	l := v.([]interface{})
	if len(l) == 0 || l[0] == nil {
		return nil, nil
	}
	...
	transformedPypiRepository, err := expandDataprocBatchRuntimeConfigRepositoryConfigPypiRepositoryConfigPypiRepository(original["pypi_repository"], d, config)
	if err != nil {
		return nil, err
	} else if val := reflect.ValueOf(transformedPypiRepository); val.IsValid() && !tpgresource.IsEmptyValue(val) {
		transformed["pypiRepository"] = transformedPypiRepository
	}

	return transformed, nil
}

func expandDataprocBatchRuntimeConfigRepositoryConfigPypiRepositoryConfigPypiRepository(v interface{}, d tpgresource.TerraformResourceData, config *transport_tpg.Config) (interface{}, error) {
	return v, nil
}
...
func expandDataprocBatchEnvironmentConfigExecutionConfig(v interface{}, d tpgresource.TerraformResourceData, config *transport_tpg.Config) (interface{}, error) {
	...
	transformedIdleTtl, err := expandDataprocBatchEnvironmentConfigExecutionConfigIdleTtl(original["idle_ttl"], d, config)
	if err != nil {
		return nil, err
...
func expandDataprocBatchEnvironmentConfigExecutionConfigIdleTtl(v interface{}, d tpgresource.TerraformResourceData, config *transport_tpg.Config) (interface{}, error) {
	return v, nil
}
