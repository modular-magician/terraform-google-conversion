...
func GetModelArmorGlobalFloorsettingApiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) (map[string]interface{}, error) {
	...
	if err != nil {
		return nil, err
	} else if v, ok := d.GetOkExists("enable_floor_setting_enforcement"); !tpgresource.IsEmptyValue(reflect.ValueOf(enableFloorSettingEnforcementProp)) && (ok || !reflect.DeepEqual(v, enableFloorSettingEnforcementProp)) {
