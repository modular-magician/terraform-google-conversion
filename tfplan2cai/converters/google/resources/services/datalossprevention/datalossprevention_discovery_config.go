...
func expandDataLossPreventionDiscoveryConfigOtherCloudStartingLocationAwsLocation(v interface{}, d tpgresource.TerraformResourceData, config *transport_tpg.Config) (interface{}, error) {
	...
	transformedOrganizationId, err := expandDataLossPreventionDiscoveryConfigOtherCloudStartingLocationAwsLocationOrganizationId(original["organization_id"], d, config)
	if err != nil {
		return nil, err
	} else if val := reflect.ValueOf(transformedOrganizationId); val.IsValid() && !tpgresource.IsEmptyValue(val) {
		transformed["organizationId"] = transformedOrganizationId
...
func expandDataLossPreventionDiscoveryConfigOtherCloudStartingLocationAwsLocationOrganizationId(v interface{}, d tpgresource.TerraformResourceData, config *transport_tpg.Config) (interface{}, error) {
	return v, nil
}
