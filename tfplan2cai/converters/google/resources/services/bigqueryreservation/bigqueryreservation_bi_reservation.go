...
func ResourceConverterBigqueryReservationBiReservation() tpgresource.ResourceConverter {
...
func GetBigqueryReservationBiReservationCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//bigqueryreservation.googleapis.com/projects/{{project}}/locations/{{location}}/biReservation")
	if err != nil {
