...
const GeminiLoggingSettingAssetType string = "staging-cloudaicompanion.sandbox.googleapis.com/LoggingSetting"
...
func GetGeminiLoggingSettingCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]cai.Asset, error) {
	name, err := cai.AssetName(d, config, "//staging-cloudaicompanion.sandbox.googleapis.com/projects/{{project}}/locations/{{location}}/loggingSettings/{{logging_setting_id}}")
	if err != nil {
...
func GetGeminiLoggingSettingApiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) (map[string]interface{}, error) {
	...
	slogMetadataProp, err := expandGeminiLoggingSettingSlogMetadata(d.Get("slog_metadata"), d, config)
	if err != nil {
		return nil, err
	} else if v, ok := d.GetOkExists("slog_metadata"); !tpgresource.IsEmptyValue(reflect.ValueOf(slogMetadataProp)) && (ok || !reflect.DeepEqual(v, slogMetadataProp)) {
		obj["slogMetadata"] = slogMetadataProp
	}
...
func expandGeminiLoggingSettingSlogMetadata(v interface{}, d tpgresource.TerraformResourceData, config *transport_tpg.Config) (interface{}, error) {
	return v, nil
}
