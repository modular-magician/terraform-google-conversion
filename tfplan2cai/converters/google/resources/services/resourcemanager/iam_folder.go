...
// FolderIamParentParentResourceIdentityParser returns the canonical folder id for google_folder_iam_member
// import via resource identity (same shape as FolderIamUpdater.GetResourceId()).
func FolderIamParentParentResourceIdentityParser(d *schema.ResourceData, identity *schema.IdentityData, _ *transport_tpg.Config) (string, error) {
