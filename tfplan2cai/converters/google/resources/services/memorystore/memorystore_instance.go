...
func GetMemorystoreInstanceApiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) (map[string]interface{}, error) {
	...
	stateInfoProp, err := expandMemorystoreInstanceStateInfo(d.Get("state_info"), d, config)
	if err != nil {
		return nil, err
	} else if v, ok := d.GetOkExists("state_info"); !tpgresource.IsEmptyValue(reflect.ValueOf(stateInfoProp)) && (ok || !reflect.DeepEqual(v, stateInfoProp)) {
		obj["stateInfo"] = stateInfoProp
	}
	...
	nodeConfigProp, err := expandMemorystoreInstanceNodeConfig(d.Get("node_config"), d, config)
	if err != nil {
		return nil, err
...
func expandMemorystoreInstanceStateInfo(v interface{}, d tpgresource.TerraformResourceData, config *transport_tpg.Config) (interface{}, error) {
	l := v.([]interface{})
	if len(l) == 0 || l[0] == nil {
		return nil, nil
	}
	...
	transformedUpdateInfo, err := expandMemorystoreInstanceStateInfoUpdateInfo(original["update_info"], d, config)
	if err != nil {
		return nil, err
	} else if val := reflect.ValueOf(transformedUpdateInfo); val.IsValid() && !tpgresource.IsEmptyValue(val) {
		transformed["updateInfo"] = transformedUpdateInfo
	}

	return transformed, nil
}

func expandMemorystoreInstanceStateInfoUpdateInfo(v interface{}, d tpgresource.TerraformResourceData, config *transport_tpg.Config) (interface{}, error) {
	l := v.([]interface{})
	if len(l) == 0 || l[0] == nil {
		return nil, nil
	}
	...
	transformedTargetShardCount, err := expandMemorystoreInstanceStateInfoUpdateInfoTargetShardCount(original["target_shard_count"], d, config)
	if err != nil {
		return nil, err
	} else if val := reflect.ValueOf(transformedTargetShardCount); val.IsValid() && !tpgresource.IsEmptyValue(val) {
		transformed["targetShardCount"] = transformedTargetShardCount
	}

	transformedTargetReplicaCount, err := expandMemorystoreInstanceStateInfoUpdateInfoTargetReplicaCount(original["target_replica_count"], d, config)
	if err != nil {
		return nil, err
	} else if val := reflect.ValueOf(transformedTargetReplicaCount); val.IsValid() && !tpgresource.IsEmptyValue(val) {
		transformed["targetReplicaCount"] = transformedTargetReplicaCount
	}

	return transformed, nil
}

func expandMemorystoreInstanceStateInfoUpdateInfoTargetShardCount(v interface{}, d tpgresource.TerraformResourceData, config *transport_tpg.Config) (interface{}, error) {
	return v, nil
}

func expandMemorystoreInstanceStateInfoUpdateInfoTargetReplicaCount(v interface{}, d tpgresource.TerraformResourceData, config *transport_tpg.Config) (interface{}, error) {
	return v, nil
}
...
func expandMemorystoreInstanceNodeConfig(v interface{}, d tpgresource.TerraformResourceData, config *transport_tpg.Config) (interface{}, error) {
	l := v.([]interface{})
	if len(l) == 0 || l[0] == nil {
		return nil, nil
	}
	...
	transformedSizeGb, err := expandMemorystoreInstanceNodeConfigSizeGb(original["size_gb"], d, config)
	if err != nil {
		return nil, err
...
func expandMemorystoreInstanceNodeConfigSizeGb(v interface{}, d tpgresource.TerraformResourceData, config *transport_tpg.Config) (interface{}, error) {
	return v, nil
}
