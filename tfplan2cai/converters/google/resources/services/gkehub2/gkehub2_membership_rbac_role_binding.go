...
func ResourceConverterGKEHub2MembershipRBACRoleBinding() tpgresource.ResourceConverter {
...
func GetGKEHub2MembershipRBACRoleBindingCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//gkehub.googleapis.com/projects/{{project}}/locations/{{location}}/memberships/{{membership_id}}/rbacrolebindings/{{membership_rbac_role_binding_id}}")
	if err != nil {
