...
func GetNetappStoragePoolApiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) (map[string]interface{}, error) {
	...
	if err != nil {
		return nil, err
	} else if v, ok := d.GetOkExists("enable_hot_tier_auto_resize"); !tpgresource.IsEmptyValue(reflect.ValueOf(enableHotTierAutoResizeProp)) && (ok || !reflect.DeepEqual(v, enableHotTierAutoResizeProp)) {
