...
const NetappBackupVaultAssetType string = "staging-netapp.sandbox.googleapis.com/BackupVault"
...
func GetNetappBackupVaultCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]cai.Asset, error) {
	name, err := cai.AssetName(d, config, "//staging-netapp.sandbox.googleapis.com/projects/{{project}}/locations/{{location}}/backupVaults/{{name}}")
	if err != nil {
