...
func ResourceConverters() map[string][]cai.ResourceConverter {
	return map[string][]cai.ResourceConverter{
		...
		"google_secure_source_manager_branch_rule_iam_policy":     {securesourcemanager.ResourceConverterSecureSourceManagerBranchRuleIamPolicy()},
		"google_secure_source_manager_branch_rule_iam_binding":    {securesourcemanager.ResourceConverterSecureSourceManagerBranchRuleIamBinding()},
		"google_secure_source_manager_branch_rule_iam_member":     {securesourcemanager.ResourceConverterSecureSourceManagerBranchRuleIamMember()},
