...
func ResourceConverters() map[string][]cai.ResourceConverter {
	return map[string][]cai.ResourceConverter{
		...
		"google_dataplex_category_iam_policy":                     {dataplex.ResourceConverterDataplexCategoryIamPolicy()},
		"google_dataplex_category_iam_binding":                    {dataplex.ResourceConverterDataplexCategoryIamBinding()},
		"google_dataplex_category_iam_member":                     {dataplex.ResourceConverterDataplexCategoryIamMember()},
