...
func GetComputeNetworkPeeringRoutesConfigApiObject(d TerraformResourceData, config *Config) (map[string]interface{}, error) {
	...
	nameProp, err := expandComputeNetworkPeeringRoutesConfigName(d.Get("name"), d, config)
	if err != nil {
		return nil, err
...
func expandComputeNetworkPeeringRoutesConfigName(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}
