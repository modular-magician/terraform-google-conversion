...
func newNotebooksInstanceIamAsset(
	...
	name, err := assetName(d, config, "//storage.googleapis.com/{{notebooks}}")
	if err != nil {
		return []Asset{}, err
	}
	...
	return []Asset{{
		Name: name,
		Type: "storage.googleapis.com/NotebooksInstance",
		IAMPolicy: &IAMPolicy{
			Bindings: bindings,
		},
	}}, nil
...
func FetchNotebooksInstanceIamPolicy(d TerraformResourceData, config *Config) (Asset, error) {
	...
	return fetchIamPolicy(
		...
		d,
		config,
		"//storage.googleapis.com/{{notebooks}}",
		"storage.googleapis.com/NotebooksInstance",
	)
}
