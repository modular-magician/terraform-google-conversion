...
func expandMLEngineJobTrainingOutputTrials(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	...
	transformedAllMetrics, err := expandMLEngineJobTrainingOutputTrialsAllMetrics(original["all_metrics"], d, config)
	if err != nil {
		return nil, err
	} else if val := reflect.ValueOf(transformedAllMetrics); val.IsValid() && !isEmptyValue(val) {
		transformed["allMetrics"] = transformedAllMetrics
	}
...
func expandMLEngineJobTrainingOutputTrialsAllMetrics(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	l := v.([]interface{})
	if len(l) == 0 || l[0] == nil {
		return nil, nil
	}
	...
	transformedTrainingStep, err := expandMLEngineJobTrainingOutputTrialsAllMetricsTrainingStep(original["training_step"], d, config)
	if err != nil {
		return nil, err
	} else if val := reflect.ValueOf(transformedTrainingStep); val.IsValid() && !isEmptyValue(val) {
		transformed["trainingStep"] = transformedTrainingStep
	...
	transformedObjectiveValue, err := expandMLEngineJobTrainingOutputTrialsAllMetricsObjectiveValue(original["objective_value"], d, config)
	if err != nil {
		return nil, err
	} else if val := reflect.ValueOf(transformedObjectiveValue); val.IsValid() && !isEmptyValue(val) {
		transformed["objectiveValue"] = transformedObjectiveValue
...
func expandMLEngineJobTrainingOutputTrialsAllMetricsTrainingStep(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandMLEngineJobTrainingOutputTrialsAllMetricsObjectiveValue(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}
...
func expandMLEngineJobTrainingOutputTrialsBuiltInAlgorithmOutput(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	...
	transformedRuntimeVersion, err := expandMLEngineJobTrainingOutputTrialsBuiltInAlgorithmOutputRuntimeVersion(original["runtime_version"], d, config)
	if err != nil {
		return nil, err
	} else if val := reflect.ValueOf(transformedRuntimeVersion); val.IsValid() && !isEmptyValue(val) {
		transformed["runtimeVersion"] = transformedRuntimeVersion
...
func expandMLEngineJobTrainingOutputTrialsBuiltInAlgorithmOutputRuntimeVersion(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}
