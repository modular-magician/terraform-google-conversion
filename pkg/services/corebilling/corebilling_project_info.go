...
const CoreBillingProjectBillingInfoAssetType string = "cloudbilling.googleapis.com/ProjectBillingInfo"

const CoreBillingProjectInfoSchemaName string = "google_billing_project_info"
