...
func expandSQLSourceRepresentationInstanceOnPremisesConfiguration(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	...
	if err != nil {
		...
		transformed["ca_certificate"] = transformedCaCertificate
	}
	...
	if err != nil {
		...
		transformed["client_certificate"] = transformedClientCertificate
	}
	...
	if err != nil {
		...
		transformed["client_key"] = transformedClientKey
	}
	...
	if err != nil {
		...
		transformed["dump_file_path"] = transformedDumpFilePath
	}
